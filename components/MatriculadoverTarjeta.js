...
function MatriculadoteverTarjeta(estudiantes) {
    let tarjetasHTML = "";
    ...
    for (let i = 0; i < estudiantes.length; i += 3) {
      ...
      for (let j = i; j < i + 3; j++) {
        if (j < estudiantes.length) {
          ...
          if (estudiante.estado === "matriculado") {
            tarjetasHTML += `
              <div class="col-md-4">
                <div class="card mb-3">
                  <div class="card-body">
                    ...
                    <p class="card-text"><strong>Estado:</strong> ${estudiante.estado}</p>
  ...
  export { MatriculadoteverTarjeta };
